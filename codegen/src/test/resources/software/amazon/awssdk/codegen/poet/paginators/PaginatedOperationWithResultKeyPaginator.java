...
public final class PaginatedOperationWithResultKeyPaginator implements SdkIterable<PaginatedOperationWithResultKeyResponse> {
    ...
    private class PaginatedOperationWithResultKeyResponseFetcher implements
        ...
        @Override
        public boolean hasNextPage(PaginatedOperationWithResultKeyResponse oldPage) {
            return oldPage.nextToken() != null;
        }

        @Override
        public PaginatedOperationWithResultKeyResponse nextPage(PaginatedOperationWithResultKeyResponse oldPage) {
            if (oldPage == null) {
