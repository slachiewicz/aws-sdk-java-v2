...
public final class PaginatedOperationWithoutResultKeyPaginator implements SdkIterable<PaginatedOperationWithoutResultKeyResponse> {
    ...
    private class PaginatedOperationWithoutResultKeyResponseFetcher implements
        ...
        @Override
        public boolean hasNextPage(PaginatedOperationWithoutResultKeyResponse oldPage) {
            return oldPage.nextToken() != null;
        }

        @Override
        public PaginatedOperationWithoutResultKeyResponse nextPage(PaginatedOperationWithoutResultKeyResponse oldPage) {
            if (oldPage == null) {
                return client.paginatedOperationWithoutResultKey(firstRequest);
            }
            return client.paginatedOperationWithoutResultKey(firstRequest.toBuilder().nextToken(oldPage.nextToken()).build());
        }
    }
}
