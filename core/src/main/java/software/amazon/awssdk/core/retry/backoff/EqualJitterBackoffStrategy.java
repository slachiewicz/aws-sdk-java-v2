...
public final class EqualJitterBackoffStrategy implements BackoffStrategy,
    ...
    public EqualJitterBackoffStrategy(Builder builder) {
        this.baseDelay = assertIsNotNegative(builder.baseDelay, "baseDelay");
        this.maxBackoffTime = assertIsNotNegative(builder.maxBackoffTime, "maxBackoffTime");
        this.numRetries = assertIsNotNegative(builder.numRetries, "numRetries");
    }
